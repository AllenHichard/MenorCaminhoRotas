...
public class Grafo {
            ...
            for (int i = 0; i < menorCaminho.length; i++) {
                ...
                if (peso != -333.333) {
                    ...
                    if (menorCaminho[vert.getId()].getPesos() + peso < menorCaminho[i].getPesos()) {
                        menorCaminho[i].setPesos(menorCaminho[vert.getId()].getPesos() + peso);
                        menorCaminho[i].setAntecessor(vert.getId());
                        //System.out.println(usar.getPertenceId());
                    }
                }
    ...
    /**
     * Esse método uma aresta, através de um vertice, e o Id e retorna seu peso
     *
     * @param vert vertice.
